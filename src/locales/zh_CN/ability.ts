...
export const ability: AbilityTranslationEntries = {
  ...
  overgrow: {
    name: "茂盛",
    description: "ＨＰ减少的时候，草属性的\n招式威力会提高。",
  },
  blaze: {
    name: "猛火",
    description: "ＨＰ减少的时候，火属性的\n招式威力会提高。",
  },
  torrent: {
    name: "激流",
    description: "ＨＰ减少的时候，水属性的\n招式威力会提高。",
  },
  swarm: {
    name: "虫之预感",
    description: "ＨＰ减少的时候，虫属性的\n招式威力会提高。",
  },
  rockHead: {
    name: "坚硬脑袋",
  ...
  wimpOut: {
    name: "跃跃欲逃",
    description: "ＨＰ变为一半时，会慌慌张\n张逃走，退回同行队伍中。",
  },
  emergencyExit: {
    name: "危险回避",
    description: "ＨＰ变为一半时，为了回避\n危险，会退回到同行队伍中。",
  },
  waterCompaction: {
    name: "遇水凝固",
    description: "受到水属性的招式攻击时，\n防御会大幅提高。",
  ...
  shieldsDown: {
    name: "界限盾壳",
    description: "ＨＰ变为一半时，壳会坏掉，\n变得有攻击性。",
  },
  stakeout: {
    name: "蹲守",
    description: "可以对替换出场的对手以２\n倍的伤害进行攻击。",
  },
  waterBubble: {
    name: "水泡",
  ...
  surgeSurfer: {
    name: "冲浪之尾",
    description: "电气场地时，速度会变为２\n倍。",
  },
  schooling: {
    name: "鱼群",
    description: "ＨＰ多的时候会聚起来变强。\nＨＰ剩余量变少时，群体\n会分崩离析。",
  },
  disguise: {
    name: "画皮",
