...
import type { PokemonPools, BiomeTierTrainerPools} from "../data/biomes";
import { BiomePoolTier, biomePokemonPools, biomeTrainerPools } from "../data/biomes";
...
import { ArenaTagSide, getArenaTag } from "../data/arena-tag";
