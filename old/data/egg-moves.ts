...
export const speciesEggMoves = {
  ...
  [Species.PIDGEY]: [ Moves.DUAL_WINGBEAT, Moves.COVET, Moves.U_TURN, Moves.RAZOR_WIND ],
  [Species.RATTATA]: [ Moves.TRAILBLAZE, Moves.POISON_FANG, Moves.JAW_LOCK, Moves.EXTREME_SPEED ],
  [Species.SPEAROW]: [ Moves.FEATHER_DANCE, Moves.SNARL, Moves.PARTING_SHOT, Moves.HYPER_DRILL ],
  ...
  [Species.ABRA]: [ Moves.MYSTICAL_FIRE, Moves.HEX, Moves.EXPANDING_FORCE, Moves.MYSTICAL_POWER ],
  ...
  [Species.TANGELA]: [ Moves.STRENGTH_SAP, Moves.NATURE_POWER, Moves.LEECH_SEED, Moves.LEAF_STORM ],
  [Species.KANGASKHAN]: [ Moves.POWER_UP_PUNCH, Moves.SKULL_BASH, Moves.HAMMER_ARM, Moves.DOUBLE_EDGE ],
  [Species.HORSEA]: [ Moves.SNIPE_SHOT, Moves.AURORA_BEAM, Moves.SCALE_SHOT, Moves.CLANGOROUS_SOUL ],
  [Species.GOLDEEN]: [ Moves.DRILL_RUN, Moves.FLIP_TURN, Moves.AQUA_TAIL, Moves.FISHIOUS_REND ],
  ...
  [Species.LAPRAS]: [ Moves.SPARKLING_ARIA, Moves.FREEZE_DRY, Moves.CHILLY_RECEPTION, Moves.BOOMBURST ],
  ...
  [Species.CHIKORITA]: [ Moves.ROCK_SLIDE, Moves.CALM_MIND, Moves.DRAGON_DANCE, Moves.MYSTICAL_FIRE ],
  ...
  [Species.AIPOM]: [ Moves.TAIL_SLAP, Moves.THUNDER_WAVE, Moves.METRONOME, Moves.SEED_BOMB ],
  ...
  [Species.WHISMUR]: [ Moves.ALLURING_VOICE, Moves.DOUBLE_HIT, Moves.SPARKLING_ARIA, Moves.TORCH_SONG ],
  ...
  [Species.WAILMER]: [ Moves.CURSE, Moves.STEAMROLLER, Moves.FREEZE_DRY, Moves.RECOVER ],
